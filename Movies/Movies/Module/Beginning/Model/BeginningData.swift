...
struct BeginningData: BeginningDataProtocol {
	...
	var paragraphs: [TitleParagraphModel] {
		...
		paragraphs.append(
			TitleParagraphModel(title: "\tНе судите строго - я не дизайнер 😅, а разработчик 🤯, но если будет поставлен четкий дизайн - поправим по Figma или Zeplin 😉 - оснавная задача \"Дизайн адаптировать под все экраны\""))
		paragraphs.append(
			TitleParagraphModel(title: "\tПри разработке использовался стек, фишки и примочки:", paragraph: ["XCode 12", "Swift 5+", "iOS 14.1", "Automatic Reference Count", "Grand Center Dispatch", "UIKit", "Digital integration (DI)", "Logger", "Property Wrapper", "UserDefaults", "SOLID", "YARCH", "NSCache", "CocoaPods", "SnapKit", "Unit test", "SmartGit", "ColorSlurp", "Sublime Text", "Postman", "NinjaMock", "Figma"]))
		paragraphs.append(
		...
		paragraphs.append(
			TitleParagraphModel(title: "\tОчень нравится изучать новые технологии и методики!!!"))
		paragraphs.append(
			TitleParagraphModel(title: "\tМой девиз - \"Ни дня без новых знаний!!!\" 🥳"))
		paragraphs.append(
